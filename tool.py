...
bot_app = None
awaiting_upload = set()
upload_paths = {}  # Store upload path per user
...
async def upload(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Store the upload path in global dict
    if args:
...
async def handle_file(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Get save path from global dict
    ...
    try:
        ...
        # Clear the path after successful upload
